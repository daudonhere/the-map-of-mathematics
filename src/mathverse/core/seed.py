...
def seed_repo_en(repo: Repository) -> None:
    topics = [
        ...
        MathConcept(
            ...
            description="The branch of algebra dealing with truth values and logical operations, used in computer science and digital logic.",
            category="Algebra",
            locale="en",
            related_concepts=["algebra", "discrete-mathematics"],
        ),
        MathConcept(
            id="computer-algebra",
            name="Computer Algebra",
            description="The branch of algebra studying algorithms and software for symbolic mathematical computation.",
            category="Algebra",
            locale="en",
            related_concepts=["algebra", "discrete-mathematics"],
        ),
...
def seed_repo_id(repo: Repository) -> None:
    topics = [
        ...
        MathConcept(
            ...
            description="Cabang aljabar yang mempelajari nilai kebenaran dan operasi logika, digunakan dalam ilmu komputer dan logika digital.",
            category="Aljabar",
            locale="id",
            related_concepts=["aljabar", "matematika-diskrit"],
        ),
        MathConcept(
            id="aljabar-komputer",
            name="Aljabar Komputer",
            description="Cabang aljabar yang mempelajari algoritma dan perangkat lunak untuk komputasi simbolik matematika.",
            category="Aljabar",
            locale="id",
            related_concepts=["aljabar", "matematika-diskrit"],
        ),
