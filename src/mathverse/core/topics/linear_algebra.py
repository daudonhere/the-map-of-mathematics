    ...
    SubTopic(
        ...
        explanation={
            "id": (
                ...
                "Dot product: (2,3)\u00b7(1,4) = 2\u00d71 + 3\u00d74 = 14 — hasil kali komponen yang dijumlahkan.\n"
                "Dot product = 0 berarti kedua vektor saling tegak lurus (ortogonal)."
            ),
            "en": (
                ...
                "Dot product: (2,3)\u00b7(1,4) = 2\u00d71 + 3\u00d74 = 14 — sum of component products.\n"
                "Dot product = 0 means the two vectors are perpendicular (orthogonal)."
            ),
        },
        examples={
            "id": [
                ...
                "Skalar: 2\u00b7(2,3) = (4,6)",
                "",
                "Dot product: (2,3)\u00b7(1,4) = 2 + 12 = 14",
                "Ortogonal jika dot = 0: (1,0)\u00b7(0,1) = 0",
            ],
            "en": [
                "Vector v = (2, 3)",
                "Magnitude: |v| = \u221a(2\u00b2 + 3\u00b2) = \u221a13",
    ...
    SubTopic(
        ...
        explanation={
            "id": (
                ...
                "Hasil kali: [[19,22],[43,50]] — gabungan hasil baris pertama dan kedua.\n"
                "Matriks identitas I = [[1,0],[0,1]] — matriks dengan diagonal 1, sisanya 0.\n"
                "Matriks identitas berperan seperti angka 1 dalam perkalian: A\u00b7I = A."
            ),
            "en": (
                ...
                "Product: [[19,22],[43,50]] — combine first and second row results.\n"
                "Identity matrix I = [[1,0],[0,1]] — matrix with 1s on diagonal, 0s elsewhere.\n"
                "Identity matrix acts like the number 1 in multiplication: A\u00b7I = A."
            ),
        },
        examples={
            "id": [
    ...
    SubTopic(
        ...
        explanation={
            "id": (
                ...
                "Kurangi tiga diagonal samping: 3\u00b75\u00b77 + 1\u00b76\u00b78 + 2\u00b74\u00b79 = 105 + 48 + 72 = 225.\n"
                "Determinan = 225 \u2212 225 = 0 — determinan nol berarti matriks singular (tidak invertible)."
            ),
            "en": (
                ...
                "Subtract three anti-diagonals: 3\u00b75\u00b77 + 1\u00b76\u00b78 + 2\u00b74\u00b79 = 105 + 48 + 72 = 225.\n"
                "Determinant = 225 \u2212 225 = 0 — zero determinant means the matrix is singular (not invertible)."
            ),
        },
        examples={
            "id": [
    ...
    SubTopic(
        ...
        explanation={
            "id": (
                ...
                "det(A \u2212 \u03bbI) = (4\u2212\u03bb)(3\u2212\u03bb) \u2212 2 = 0 — perluas: \u03bb\u00b2 \u2212 7\u03bb + 12 \u2212 2 = \u03bb\u00b2 \u2212 7\u03bb + 10.\n"
                "\u03bb\u00b2 \u2212 7\u03bb + 10 = 0 — faktorkan menjadi (\u03bb \u2212 5)(\u03bb \u2212 2) = 0.\n"
                "Nilai eigen: \u03bb\u2081 = 5 dan \u03bb\u2082 = 2 — nilai eigen menunjukkan faktor skala transformasi."
            ),
            "en": (
                ...
                "det(A \u2212 \u03bbI) = (4\u2212\u03bb)(3\u2212\u03bb) \u2212 2 = 0 — expand: \u03bb\u00b2 \u2212 7\u03bb + 12 \u2212 2 = \u03bb\u00b2 \u2212 7\u03bb + 10.\n"
                "\u03bb\u00b2 \u2212 7\u03bb + 10 = 0 — factor to (\u03bb \u2212 5)(\u03bb \u2212 2) = 0.\n"
                "Eigenvalues: \u03bb\u2081 = 5 and \u03bb\u2082 = 2 — eigenvalues represent the scaling factor of the transformation."
            ),
        },
        examples={
            "id": [
    ...
    SubTopic(
        ...
        explanation={
            "id": (
                ...
                "v\u2082 = (0,1) — vektor eigen untuk \u03bb = 3, tegak lurus terhadap v\u2081.\n"
                "Verifikasi: A\u00b7v\u2081 = (2,0) = 2\u00b7v\u2081 — vektor eigen hanya berubah panjang sesuai nilai eigen."
            ),
            "en": (
                ...
                "v\u2082 = (0,1) — eigenvector for \u03bb = 3, perpendicular to v\u2081.\n"
                "Verification: A\u00b7v\u2081 = (2,0) = 2\u00b7v\u2081 — eigenvector only changes length by the eigenvalue factor."
            ),
        },
        examples={
            "id": [
