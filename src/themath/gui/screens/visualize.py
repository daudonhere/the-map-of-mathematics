...
class VisualizeScreen(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        title = QLabel(self.service._("concept_connections"))
        ...
        refresh_btn = QPushButton(self.service._("refresh"))
    ...
    def refresh(self) -> None:
        ...
        if not concepts:
            self.browser.setText(self.service._("no_concepts_available"))
            return
        lines = [
            f"<b>{self.service._('app_title')} - {self.service._('all_connections')}</b>",
            "",
            "",
        ]
        for c in concepts:
